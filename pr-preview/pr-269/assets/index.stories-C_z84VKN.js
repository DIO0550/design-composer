import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-B-7AsI0c.js";import{a as i,i as a}from"./sample-editor-state-xsMjMHVO.js";import{n as o,r as s}from"./canvas-view-C0XpIrCi.js";import{t as c}from"./jsx-runtime-CcHvAHjA.js";import{a as l,c as u,n as d,o as f,r as p,s as m,t as h}from"./editor-top-bar-Ad415ICS.js";function g({tone:e,saveState:t,fileErrors:n,elapsed:r}){return(0,_.jsxs)(h,{tone:e,children:[(0,_.jsx)(h.Breadcrumb,{opened:v}),t?(0,_.jsx)(h.SaveBadge,{state:t}):null,n?(0,_.jsx)(h.FileInvalidBadge,{errors:n}):null,(0,_.jsx)(h.Zoom,{view:o.create(),onZoomIn:()=>{},onZoomOut:()=>{},onReset:()=>{}}),r?(0,_.jsx)(h.LastValidRender,{elapsed:r}):null]})}var _,v,y,b,x,S,C,w,T;e((()=>{t(),u(),f(),i(),s(),p(),_=c(),v={path:`/work/settings-ui/app.dcmp`,document:r.createFromTemplate(n.Default)},y={title:`features/editor/EditorTopBar`,component:g,parameters:{layout:`fullscreen`},args:{tone:d.Normal}},b={name:`保存済み`,args:{saveState:m.Saved}},x={name:`保存中`,args:{saveState:m.Saving}},S={name:`保存に失敗`,args:{saveState:m.fromError({kind:`permissionDenied`,message:`/work/settings-ui/app.dcmp: 書き込みが許可されていない`})}},C={name:`最後に正常だった表示を出している状態`,args:{saveState:m.Saved,elapsed:{unit:l.Seconds,count:4}}},w={name:`ファイルが不正`,args:{tone:d.Error,fileErrors:a,elapsed:{unit:l.Seconds,count:4}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: "保存済み",
  args: {
