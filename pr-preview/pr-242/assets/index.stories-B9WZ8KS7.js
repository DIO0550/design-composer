import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./design-document-CXNsDfv9.js";import{a as r,n as i,r as a}from"./sample-editor-state-CzY0SxYl.js";import{n as o,t as s}from"./editor-state-DVWJl9qk.js";import{t as c}from"./jsx-runtime-ChEsXk_u.js";import{n as l,t as u}from"./property-panel-BA8NYshi.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{t(),r(),o(),l(),d=c(),{fn:f}=__STORYBOOK_MODULE_TEST__,p=`very-long-node-name-that-does-not-fit-in-the-heading`,m=s.create(n.create({artboards:[{name:`home`,width:360,height:240,children:[{name:`unset-box`,type:`Box`,props:{background:`missing`}}]}]})),h=s.create(n.create({artboards:[{name:`home`,width:360,height:240,children:[{name:p,type:`Box`}]}]})),g={title:`features/editor/PropertyPanel`,component:u,parameters:{layout:`padded`},decorators:[e=>(0,d.jsx)(`div`,{className:`flex h-[32rem] w-72 flex-col border border-gray-300 bg-white`,children:(0,d.jsx)(e,{})})],args:{onClearSelection:f(),onEditProp:f(),instance:{goToSource:f(),selectAllInstances:f(),detach:f()}}},_={name:`選択されていない`,args:{state:a}},v={name:`artboard を選択中`,args:{state:s.select(a,`home`)}},y={name:`Text ノードを選択中`,args:{state:s.select(a,`home-title`)}},b={name:`インスタンスを選択中（publicProps から生成）`,args:{state:s.select(a,`home-login`)}},x={name:`Box ノードを選択中`,args:{state:s.select(a,`overflow-wide`)}},S={name:`未指定の prop だけの Box を選択中`,args:{state:s.select(m,`unset-box`)}},C={name:`名前が長いノードを選択中`,args:{state:s.select(h,p)}},w={name:`凍結中`,args:{state:i}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: "選択されていない",
  args: {
