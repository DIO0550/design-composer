import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-zv26h0CU.js";import{a as i,i as a}from"./sample-editor-state-Dba_CfiY.js";import{n as o,r as s}from"./canvas-view-CRTN-ucG.js";import{t as c}from"./jsx-runtime-Cw9gq7QB.js";import{a as l,c as u,i as d,n as f,o as p,r as m,s as h}from"./elapsed-D8Rza_h7.js";function g({tone:e,saveState:t,fileErrors:n,elapsed:r}){return(0,_.jsxs)(h,{tone:e,children:[(0,_.jsx)(h.Breadcrumb,{opened:v}),t?(0,_.jsx)(h.SaveBadge,{state:t}):null,n?(0,_.jsx)(h.FileInvalidBadge,{errors:n}):null,(0,_.jsx)(h.Zoom,{view:o.create(),onZoomIn:()=>{},onZoomOut:()=>{},onReset:()=>{}}),r?(0,_.jsx)(h.LastValidRender,{elapsed:r}):null]})}var _,v,y,b,x,S,C,w,T;e((()=>{t(),i(),s(),l(),m(),u(),_=c(),v={path:`/work/settings-ui/app.dcmp`,document:r.createFromTemplate(n.DEFAULT)},y={title:`features/editor/EditorTopBar`,component:g,parameters:{layout:`fullscreen`},args:{tone:p.normal}},b={name:`保存済み`,args:{saveState:d.SAVED}},x={name:`保存中`,args:{saveState:d.SAVING}},S={name:`保存に失敗`,args:{saveState:d.fromError({kind:`permissionDenied`,message:`/work/settings-ui/app.dcmp: 書き込みが許可されていない`})}},C={name:`最後に正常だった表示を出している状態`,args:{saveState:d.SAVED,elapsed:{unit:f.Seconds,count:4}}},w={name:`ファイルが不正`,args:{tone:p.error,fileErrors:a,elapsed:{unit:f.Seconds,count:4}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: "保存済み",
  args: {
