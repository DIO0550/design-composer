...
}`,...x.parameters?.docs?.source},description:{story:`どの prop も未指定で、色の参照だけが宙に浮いている状態。`,...x.parameters?.docs?.description}}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "名前が長いノードを選択中",
  args: {
