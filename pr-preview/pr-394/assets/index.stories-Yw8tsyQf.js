import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{a as n,r}from"./compiled-element-kKtjlNI5.js";import{n as i,t as a}from"./resize-handle-style-wk4P5Xtt.js";var o,s,c,l,u;e((()=>{n(),i(),o=t(),s={title:`features/canvas/ArtboardCanvas/ResizeHandleStyle`,component:a,parameters:{layout:`fullscreen`,docs:{description:{component:`選択中の要素に出すリサイズハンドル（docs/06-ui.md「リサイズハンドル」）。
...
}`,...c.parameters?.docs?.source},description:{story:"選択中の要素。掴める軸が 1 つでもあれば四隅に 4 個出る\n（UI 案の `login-form` は width=fixed / height=hug でも 4 個）。",...c.parameters?.docs?.description}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: "倍率 2 倍",
  args: {
    scale: 2
  }
