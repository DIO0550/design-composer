import{n as e}from"./chunk-BneVvdWh.js";import{i as t,r as n}from"./ArrayEx-CtQdU7_T.js";import{n as r,t as i}from"./Option-CPpfsGoD.js";import{t as a}from"./jsx-runtime-D16BNjX-.js";import{n as o,r as s,t as c}from"./design-document-BLHu3E4t.js";import{n as l,t as u}from"./document-selection-DFqdCoeV.js";import{n as d,t as f}from"./token-selection-Bvtn7Y3x.js";import{i as p,r as m}from"./use-node-drag-QN3mM9_C.js";import{r as h,t as g}from"./artboard-frame-list-aG15nH7M.js";import{i as _,r as v}from"./sample-canvas-document-DLMIrj0E.js";import{n as y,t as b}from"./canvas-controls-BEXYUo6W.js";function x({selection:e}){let t=m.compile(e.document);return n.isOk(t)?(0,S.jsx)(b,{selection:e,children:n=>(0,S.jsx)(g,{compiled:t.value,selection:e,tokenSelection:f.create(e.document,i.none),onSelect:()=>{},onContextMenu:()=>{},...n})}):(0,S.jsxs)(`p`,{children:[`コンパイルに失敗しました: `,t.error.message]})}var S,C,w,T,E,D,O;e((()=>{o(),l(),d(),v(),p(),r(),t(),y(),h(),S=a(),C={title:`features/canvas/ArtboardCanvas/ArtboardFrameList`,component:x,parameters:{layout:`fullscreen`},decorators:[e=>(0,S.jsx)(`div`,{className:`h-[32rem] w-full overflow-auto bg-gray-100`,children:(0,S.jsx)(e,{})})]},w={name:`選択なし`,args:{selection:_()}},T={name:`artboard を選択中`,args:{selection:_([`settings`])}},E={name:`配下のノードを選択中`,args:{selection:_([`overflow-wide`])}},D={name:`キャンバス上の座標を持つ artboard`,args:{selection:u.fromNames(c.create({tokens:s.Default.tokens,components:s.Default.components,artboards:[{name:`first`,width:200,height:140,children:[]},{name:`placed`,width:200,height:140,canvasPosition:{x:620,y:220},children:[]},{name:`second`,width:200,height:140,children:[]}]}),[])}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
