import{n as e}from"./chunk-BneVvdWh.js";import{r as t,t as n}from"./document-access-failure-jQC-tVkl.js";import{i as r,t as i}from"./document-open-failure-BwdA8-xY.js";var a,o,s,c,l;e((()=>{t(),r(),a={title:`features/documentStart/DocumentOpenFailureBanner`,component:i,parameters:{layout:`fullscreen`},args:{failure:{kind:`io`,error:n.create(`missing`,`/work/settings-ui/app.dcmp`)}}},o={name:`ファイルが見つからない`},s={name:`ファイルを選べなかった`,args:{failure:{kind:`dialog`,error:{message:`dialog.open not allowed`}}}},c={name:`ドキュメントとして読み取れない`,args:{failure:{kind:`unparsable`,errors:[{kind:`syntax-error`,message:`unexpected end of JSON input`,location:{kind:`text-position`,position:19}}]}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: "ファイルが見つからない"
