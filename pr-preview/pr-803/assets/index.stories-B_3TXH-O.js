import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-D16BNjX-.js";import{n,t as r}from"./prop-row-BJvcGnGr.js";import{h as i,i as a,m as o,t as s}from"./panel-controls-D4DgSt00.js";import{n as c,t as l}from"./panel-frame-B9J5lG90.js";var u,d,f,p,m,h,g;e((()=>{i(),c(),n(),u=t(),{fn:d}=__STORYBOOK_MODULE_TEST__,f={title:`features/editor/features/inspector/PropertyPanel/PropRow`,component:r,parameters:{layout:`padded`,docs:{description:{component:`1 prop 分の行。

ラベル欄の幅・条件付きの行の字下げ・未指定の注記はいずれも class の違いにしか
出ないので、崩れに気づける手段は視覚差分だけ。`}}},decorators:[e=>(0,u.jsx)(l,{children:(0,u.jsx)(e,{})})],args:{onEdit:d()}},p={name:`値の入った行`,args:{control:s}},m={name:`未指定の enum（既定の注記が付く）`,args:{control:a}},h={name:`条件付きの行（ラベルを出さず字下げする）`,args:{control:o}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: "値の入った行",
  args: {
