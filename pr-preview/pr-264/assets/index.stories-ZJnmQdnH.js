import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-B-7AsI0c.js";import{a as i,i as a}from"./sample-editor-state-BD_hYwet.js";import{n as o,r as s}from"./canvas-view-DpfZEcyn.js";import{t as c}from"./jsx-runtime-ChEsXk_u.js";import{a as l,c as u,i as d,n as f,o as p,r as m,s as h}from"./elapsed-C7fpRnnQ.js";function g({tone:e,saveState:t,fileErrors:n,elapsed:r}){return(0,_.jsxs)(p,{tone:e,children:[(0,_.jsx)(p.Breadcrumb,{opened:v}),t?(0,_.jsx)(p.SaveBadge,{state:t}):null,n?(0,_.jsx)(p.FileInvalidBadge,{errors:n}):null,(0,_.jsx)(p.Zoom,{view:o.create(),onZoomIn:()=>{},onZoomOut:()=>{},onReset:()=>{}}),r?(0,_.jsx)(p.LastValidRender,{elapsed:r}):null]})}var _,v,y,b,x,S,C,w,T;e((()=>{t(),i(),s(),l(),m(),u(),_=c(),v={path:`/work/settings-ui/app.dcmp`,document:r.createFromTemplate(n.Default)},y={title:`features/editor/EditorTopBar`,component:g,parameters:{layout:`fullscreen`},args:{tone:h.Normal}},b={name:`保存済み`,args:{saveState:d.Saved}},x={name:`保存中`,args:{saveState:d.Saving}},S={name:`保存に失敗`,args:{saveState:d.fromError({kind:`permissionDenied`,message:`/work/settings-ui/app.dcmp: 書き込みが許可されていない`})}},C={name:`最後に正常だった表示を出している状態`,args:{saveState:d.Saved,elapsed:{unit:f.Seconds,count:4}}},w={name:`ファイルが不正`,args:{tone:h.Error,fileErrors:a,elapsed:{unit:f.Seconds,count:4}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: "保存済み",
  args: {
