import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-B-7AsI0c.js";import{t as i}from"./jsx-runtime-4HHWW5MW.js";import{a,n as o,r as s}from"./sample-editor-state-BonV94ow.js";import{n as c,t as l}from"./editor-state-CsGynqsh.js";import{n as u,r as d,t as f}from"./property-panel-Bb-D2RY9.js";var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{t(),a(),c(),d(),p=i(),{expect:m,fn:h,screen:g,userEvent:_}=__STORYBOOK_MODULE_TEST__,v=`very-long-node-name-that-does-not-fit-in-the-heading`,y=l.create(r.create({artboards:[{name:`home`,width:360,height:240,children:[{name:`unset-box`,type:`Box`,props:{background:`missing`}}]}]})),b=l.create(r.create({tokens:n.Default.tokens,artboards:[{name:`home`,width:360,height:240,children:[{name:`uniform-padding-box`,type:`Box`,props:{paddingTop:`md`,paddingRight:`md`,paddingBottom:`md`,paddingLeft:`md`}},{name:`mixed-padding-box`,type:`Box`,props:{paddingTop:`sm`,paddingRight:`lg`,paddingBottom:`md`,paddingLeft:`lg`}}]}]})),x=l.create(r.create({artboards:[{name:`home`,width:360,height:240,children:[{name:v,type:`Box`}]}]})),S={title:`features/editor/PropertyPanel`,component:f,parameters:{layout:`padded`},decorators:[e=>(0,p.jsx)(`div`,{className:`flex h-[32rem] w-72 flex-col border border-gray-300 bg-white`,children:(0,p.jsx)(e,{})})],args:{onClearSelection:h(),onEditProp:h(),instance:{goToSource:h(),selectAllInstances:h(),detach:h()}}},C={name:`選択されていない`,args:{state:s}},w={name:`artboard を選択中`,args:{state:l.select(s,`home`)}},T={name:`Text ノードを選択中`,args:{state:l.select(s,`home-title`)}},E={name:`インスタンスを選択中（publicProps から生成）`,args:{state:l.select(s,`home-login`)}},D={name:`Box ノードを選択中`,args:{state:l.select(s,`overflow-wide`)}},O={name:`未指定の prop だけの Box を選択中`,args:{state:l.select(y,`unset-box`)}},k={name:`名前が長いノードを選択中`,args:{state:l.select(x,v)}},A={name:`凍結中`,args:{state:o}},j={name:`padding が揃っている Box を選択中`,args:{state:l.select(b,`uniform-padding-box`)}},M={name:`padding が不揃いな Box を選択中`,args:{state:l.select(b,`mixed-padding-box`)}},N={name:`padding を辺ごとに出した Box を選択中`,args:{state:l.select(b,`mixed-padding-box`)},play:async()=>{await _.click(g.getByRole(`button`,{name:u.perEdge})),await m(g.getByRole(`combobox`,{name:`Padding Top`})).toBeDefined()}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  name: "選択されていない",
  args: {
