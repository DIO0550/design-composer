import{n as e}from"./chunk-BneVvdWh.js";import{M as t,j as n}from"./primitive-schema-Ke4zSQuu.js";import{f as r,n as i,p as a,r as o,t as s}from"./design-document-B-7AsI0c.js";import{t as c}from"./jsx-runtime-ChEsXk_u.js";import{n as l,r as u,t as d}from"./asset-grab-BXKJucC8.js";import{n as f,t as p}from"./component-list-BMixULJW.js";var m,h,g,_,v,y,b,x;e((()=>{a(),i(),l(),t(),f(),m=c(),h={title:`features/editor/ComponentList`,component:p,parameters:{layout:`padded`},decorators:[e=>(0,m.jsx)(`div`,{className:`w-64 border border-gray-300 bg-white p-3`,children:(0,m.jsx)(e,{})})],args:{sourceName:n.none,grab:u()}},g=s.create({components:o.Default.components,artboards:[r.create({name:`home`,width:360,height:240,children:[{name:`home-login`,ref:`primary-button`},{name:`home-cancel`,ref:`primary-button`},{name:`home-card`,ref:`card`}]})]}),_={name:`使用数のある部品`,args:{assets:s.componentAssets(g)}},v={name:`部品がない`,args:{assets:[]}},y={name:`行を掴んで運んでいる`,args:{assets:s.componentAssets(g),grab:d(`primary-button`)}},b={name:`選択中のインスタンスの元になっている部品がある`,args:{assets:s.componentAssets(g),sourceName:n.some(`primary-button`)}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: "使用数のある部品",
  args: {
