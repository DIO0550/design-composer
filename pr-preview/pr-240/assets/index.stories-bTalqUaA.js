import{n as e}from"./chunk-BneVvdWh.js";import{D as t,k as n,n as r,t as i}from"./design-document-CmzPaaBf.js";import{a,o,r as s,s as c}from"./sample-editor-state-60TsMZsV.js";import{t as l}from"./jsx-runtime-Cw9gq7QB.js";import{n as u,t as d}from"./token-dashed-nodes-Ds46EwJz.js";var f,p,m,h,g,_;e((()=>{r(),n(),a(),c(),u(),f=l(),p={title:`features/editor/TokenDashedNodes`,component:d,decorators:[e=>(0,f.jsx)(`div`,{className:`flex bg-gray-100 p-6`,children:(0,f.jsx)(e,{})})],parameters:{docs:{description:{component:`帯は灰色のキャンバス面に影付きで浮く部品なので、decorator で面と余白を与える。
白地に置くと影と角丸が沈み、実画面と違うものが視覚差分の基準になる。`}}}},m={name:`参照が1件`,args:{state:o.selectToken(s,{kind:`colors`,name:`primary`})}},h={name:`参照が複数`,args:{state:o.selectToken(o.create(i.create({tokens:{...t.empty(),colors:{"gray-900":`#111827`}},artboards:[{name:`home`,width:360,height:240,children:[{name:`home-title`,type:`Text`,props:{content:`ホーム`,color:`gray-900`}},{name:`home-caption`,type:`Text`,props:{content:`説明`,color:`gray-900`}}]}]})),{kind:`colors`,name:`gray-900`})}},g={name:`色以外のトークン`,args:{state:o.selectToken(s,{kind:`typography`,name:`heading`})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  name: "参照が1件",
  args: {
