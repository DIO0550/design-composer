import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./design-document-BfhMav98.js";import{n as i,t as a}from"./screen-height-shell-D7M0puoE.js";import{_ as o,b as s,x as c,y as l}from"./editor-top-bar-BGknV3bo.js";import{a as u,i as d,l as f,n as p,o as m,r as h,t as g,u as _}from"./opened-document-editor-Cb-KKYFB.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;e((()=>{n(),l(),i(),c(),_(),m(),d(),p(),v=t(),{expect:y,screen:b,waitFor:x}=__STORYBOOK_MODULE_TEST__,S=`/work/sample.dcmp`,C=u.create({[S]:h.serialize(s.document(o))}),w={title:`features/editor/OpenedDocumentEditor`,component:g,parameters:{layout:`fullscreen`},decorators:[e=>(0,v.jsx)(a,{children:(0,v.jsx)(e,{})})],args:{clock:f.create().clock,ipc:C.ipc,opened:{path:S,document:s.document(o)}}},T={name:`編集画面`},E={name:`同期に失敗した編集画面`,args:{ipc:u.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:s.document(o)}}},D=s.document(o),O=r.create({components:D.components,artboards:D.artboards,tokens:{...D.tokens,typography:Object.fromEntries(Object.entries(D.tokens.typography).filter(([e])=>e!==`heading`))}}),k={name:`ドキュメント自身が不正な編集画面`,args:{ipc:u.create({[S]:h.serialize(O)}).ipc,opened:{path:S,document:O}}},A=r.create({tokens:D.tokens,components:D.components,artboards:D.artboards.map(e=>e.name===`home`?{...e,children:[{name:`home-badge`,type:`Box`,props:{placement:`absolute`,x:296,y:16,widthMode:`fixed`,width:44,heightMode:`fixed`,height:24,background:`primary`,radius:`md`},children:[]},...e.children]}:e)}),j=u.create({[S]:h.serialize(A)}),M={name:`絶対配置のノードがある編集画面`,args:{ipc:j.ipc,opened:{path:S,document:A}}},N={name:`home-login`,ref:`居ない部品`,overrides:{label:`ログイン`}},P=r.create({tokens:D.tokens,components:D.components,artboards:D.artboards.map(e=>({...e,children:e.children.map(e=>e.name===N.name?N:e)}))}),F={name:`コンパイルできないドキュメントの編集画面`,args:{ipc:u.create({[S]:h.serialize(P)}).ipc,opened:{path:S,document:P}}},I=u.create({[S]:h.serialize(s.document(o))}),L={name:`ファイルが不正になった編集画面`,args:{ipc:I.ipc,opened:{path:S,document:s.document(o)}},play:async()=>{await x(()=>{y(I.isWatching(S)).toBe(!0)}),I.changeExternally(S,`{ 壊れた`),await x(()=>{y(b.getByText(`最後に正常だった表示`)).toBeDefined()})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
...
}`,...L.parameters?.docs?.source},description:{story:`外部編集でファイルが壊れた編集画面（#135）。**このストーリーだけが 3 ペインの凍結を
...
happy-dom 側（\`opened-document-editor.frozen.test.tsx\`）で確かめている。`,...L.parameters?.docs?.description}}},R=[`Default`,`SyncFailed`,`DocumentErrors`,`AbsolutePlacement`,`CompileFailed`,`FileInvalid`]}))();export{M as AbsolutePlacement,F as CompileFailed,T as Default,k as DocumentErrors,L as FileInvalid,E as SyncFailed,R as __namedExportsOrder,w as default};