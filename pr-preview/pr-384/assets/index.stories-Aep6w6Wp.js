import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-CTa-i89e.js";import{n as i,t as a}from"./token-selection-CYBa_hem.js";import{n as o,t as s}from"./document-selection-I_q2MEMb.js";import{i as c,n as l,r as u,t as d}from"./sample-canvas-document-XAoOz7Cp.js";import{c as f,s as p}from"./artboard-frame-Rly_sqx2.js";import{i as m,n as h,r as g,t as _}from"./artboard-canvas-BhfCSCjs.js";function v(e){let t=m(),n=f({document:e.selection.document,view:t.view,onMove:()=>{},onInsertAt:()=>{},onReposition:()=>{}});return(0,y.jsx)(_,{...e,canvasView:t,nodeDrag:n})}var y,b,x,S,C,w,T,E,D;e((()=>{o(),i(),u(),g(),p(),n(),h(),y=t(),{fn:b}=__STORYBOOK_MODULE_TEST__,x={title:`features/canvas/ArtboardCanvas`,component:v,parameters:{layout:`fullscreen`},decorators:[e=>(0,y.jsx)(`div`,{className:`h-screen bg-gray-100`,children:(0,y.jsx)(e,{})})],args:{tokenSelection:a.create(l,r.none),isFrozen:!1,onSelect:b(),onResize:b(),onEditProp:b()}},S={name:`選択なし`,args:{selection:c()}},C={name:`artboard を選択中`,args:{selection:c([`settings`])}},w={name:`トークンを選択中`,args:{selection:c(),tokenSelection:a.create(l,r.some({kind:`colors`,name:`primary`}))}},T={name:`artboard がない`,args:{selection:s.fromNames(d,[]),tokenSelection:a.create(d,r.none)}},E={name:`ファイルが不正（凍結中）`,args:{selection:c([`home`]),isFrozen:!0}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
