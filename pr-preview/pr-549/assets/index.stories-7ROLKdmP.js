import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-CPpfsGoD.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{n as i,t as a}from"./screen-height-shell-DlMq_mLQ.js";import{a as o,s}from"./opened-document-CjvIuWFa.js";import{i as c,n as l,r as u,t as d}from"./document-start-CHSTFRH9.js";var f,p,m,h,g,_,v,y,b,x;e((()=>{i(),s(),c(),t(),l(),f=r(),p={openDocument:()=>{},createDocument:()=>{},openDocumentAt:()=>{}},m=[`/work/settings-ui/app.dcmp`,`/work/shop/app.dcmp`,`/work/design-system/tokens.dcmp`],h={title:`features/documentStart/DocumentStart`,component:d,parameters:{layout:`fullscreen`},args:{session:{kind:`closed`},actions:p,recentPaths:[],commandFailure:n.none,renderErrors:()=>null},decorators:[e=>(0,f.jsx)(a,{children:(0,f.jsx)(e,{})})]},g={name:`開始画面`},_={name:`最近使ったファイルがある`,args:{recentPaths:m}},v={name:`読み込み中`,args:{session:{kind:`opening`}}},y={name:`開けなかった`,args:{session:{kind:`failed`,failure:{kind:`io`,error:o.create(`missing`,`/work/settings-ui/app.dcmp`)}}}},b={name:`メニューを受け取れない`,args:{commandFailure:n.some({source:u.Menu,message:`listen が失敗した`})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: "開始画面"
