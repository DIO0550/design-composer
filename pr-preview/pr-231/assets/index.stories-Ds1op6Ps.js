import{n as e}from"./chunk-BneVvdWh.js";import{a as t,o as n,r,s as i}from"./sample-editor-state-DpvWz2Cq.js";import{t as a}from"./jsx-runtime-Cw9gq7QB.js";import{n as o,t as s}from"./token-used-by-Bj5-DPEs.js";var c,l,u,d,f,p;e((()=>{t(),i(),o(),c=a(),l={title:`features/editor/TokenUsedBy`,component:s,parameters:{layout:`padded`},decorators:[e=>(0,c.jsx)(`div`,{className:`w-72 border border-gray-300 bg-white p-3`,children:(0,c.jsx)(e,{})})]},u={name:`参照されていない`,args:{state:n.selectToken(r,{kind:`colors`,name:`danger`})}},d={name:`上限内の件数`,args:{state:n.selectToken(r,{kind:`colors`,name:`primary`})}},f={name:`上限を超える件数`,args:{state:n.selectToken(r,{kind:`spacing`,name:`md`})}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  name: "参照されていない",
  args: {
