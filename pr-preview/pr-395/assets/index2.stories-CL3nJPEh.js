import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-CTa-i89e.js";import{n as i,r as a,t as o}from"./design-document-DyhxCh3S.js";import{n as s,t as c}from"./document-selection-Bf5r4HtY.js";import{n as l,t as u}from"./token-selection-RR4FNv1u.js";import{i as d,r as f}from"./sample-canvas-document-CoIFvyZ8.js";import{_ as p,v as m}from"./artboard-frame-CY0vYMUR.js";import{n as h,t as g}from"./canvas-controls-CdoRq8XT.js";import{n as _,t as v}from"./artboard-frame-list-BZC9UQ-B.js";function y({selection:e}){let t=p.compile(e.document);return t.ok?(0,b.jsx)(g,{selection:e,children:n=>(0,b.jsx)(v,{compiled:t.value,selection:e,tokenSelection:u.create(e.document,r.none),onSelect:()=>{},...n})}):(0,b.jsxs)(`p`,{children:[`コンパイルに失敗しました: `,t.error.message]})}var b,x,S,C,w,T,E;e((()=>{i(),s(),l(),f(),m(),n(),h(),_(),b=t(),x={title:`features/canvas/ArtboardCanvas/ArtboardFrameList`,component:y,parameters:{layout:`fullscreen`},decorators:[e=>(0,b.jsx)(`div`,{className:`h-[32rem] w-full overflow-auto bg-gray-100`,children:(0,b.jsx)(e,{})})]},S={name:`選択なし`,args:{selection:d()}},C={name:`artboard を選択中`,args:{selection:d([`settings`])}},w={name:`配下のノードを選択中`,args:{selection:d([`overflow-wide`])}},T={name:`キャンバス上の座標を持つ artboard`,args:{selection:c.fromNames(o.create({tokens:a.Default.tokens,components:a.Default.components,artboards:[{name:`first`,width:200,height:140,children:[]},{name:`placed`,width:200,height:140,canvasPosition:{x:620,y:220},children:[]},{name:`second`,width:200,height:140,children:[]}]}),[])}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
