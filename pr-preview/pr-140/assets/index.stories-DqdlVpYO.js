import{n as e}from"./chunk-BneVvdWh.js";import{a as t,i as n,n as r,r as i}from"./sample-editor-state-aY8mLVaA.js";import{a,c as o,n as s,o as c,s as l,t as u}from"./opened-document-editor-BCHqvjyP.js";var d,f,p,m,h;e((()=>{i(),t(),o(),c(),s(),d=`/work/sample.dcmp`,f={title:`features/editor/OpenedDocumentEditor`,component:u,parameters:{layout:`fullscreen`},args:{ipc:l.create({[d]:a.serialize(n.document(r))}).ipc,opened:{path:d,document:n.document(r)}}},p={name:`編集画面`},m={name:`同期に失敗した編集画面`,args:{ipc:l.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:n.document(r)}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
