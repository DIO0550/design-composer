import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./design-document-C_sOCNU3.js";import{n as i,t as a}from"./screen-height-shell-DJmJ8YA6.js";import{n as o,t as s}from"./document-json-wPDhSt-L.js";import{f as c,g as l,h as u,m as d}from"./editor-top-bar-ZDe0HoxX.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./opened-document-editor-Cg4Pdjcd.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L;e((()=>{i(),n(),d(),l(),h(),p(),o(),m(),v=t(),{expect:y,screen:b,waitFor:x}=__STORYBOOK_MODULE_TEST__,S=`/work/sample.dcmp`,C=g.create({[S]:s.serialize(u.document(c))}),w={title:`features/editor/OpenedDocumentEditor`,component:_,parameters:{layout:`fullscreen`},decorators:[e=>(0,v.jsx)(a,{children:(0,v.jsx)(e,{})})],args:{clock:f.create().clock,ipc:C.ipc,opened:{path:S,document:u.document(c)}}},T={name:`編集画面`},E={name:`同期に失敗した編集画面`,args:{ipc:g.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:u.document(c)}}},D=u.document(c),O=r.create({components:D.components,artboards:D.artboards,tokens:{...D.tokens,typography:Object.fromEntries(Object.entries(D.tokens.typography).filter(([e])=>e!==`heading`))}}),k={name:`ドキュメント自身が不正な編集画面`,args:{ipc:g.create({[S]:s.serialize(O)}).ipc,opened:{path:S,document:O}}},A=r.create({tokens:D.tokens,components:D.components,artboards:D.artboards.map(e=>e.name===`home`?{...e,children:[{name:`home-badge`,type:`Box`,props:{placement:`absolute`,x:296,y:16,widthMode:`fixed`,width:44,heightMode:`fixed`,height:24,background:`primary`,radius:`md`},children:[]},...e.children]}:e)}),j={name:`絶対配置のノードがある編集画面`,args:{ipc:g.create({[S]:s.serialize(A)}).ipc,opened:{path:S,document:A}}},M={name:`home-login`,ref:`居ない部品`,overrides:{label:`ログイン`}},N=r.create({tokens:D.tokens,components:D.components,artboards:D.artboards.map(e=>({...e,children:e.children.map(e=>e.name===M.name?M:e)}))}),P={name:`コンパイルできないドキュメントの編集画面`,args:{ipc:g.create({[S]:s.serialize(N)}).ipc,opened:{path:S,document:N}}},F=g.create({[S]:s.serialize(u.document(c))}),I={name:`ファイルが不正になった編集画面`,args:{ipc:F.ipc,opened:{path:S,document:u.document(c)}},play:async()=>{await x(()=>{y(F.isWatching(S)).toBe(!0)}),F.changeExternally(S,`{ 壊れた`),await x(()=>{y(b.getByText(`最後に正常だった表示`)).toBeDefined()})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
