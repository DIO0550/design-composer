import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n}from"./sample-editor-state-BA_8adlc.js";import{a as r,c as i,n as a,o,s,t as c}from"./opened-document-editor-D7-hEjB2.js";var l,u,d,f,p;e((()=>{n(),i(),o(),a(),l=`/work/sample.dcmp`,u={title:`features/editor/OpenedDocumentEditor`,component:c,parameters:{layout:`fullscreen`},args:{ipc:s.create({[l]:r.serialize(t.document)}).ipc,opened:{path:l,document:t.document}}},d={name:`編集画面`},f={name:`同期に失敗した編集画面`,args:{ipc:s.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:t.document}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
