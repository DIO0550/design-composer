import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-CTa-i89e.js";import{n as i,t as a}from"./document-selection-B_6TfRxM.js";import{n as o,t as s}from"./token-selection-DBUukh6r.js";import{i as c,n as l,r as u,t as d}from"./sample-canvas-document-BhANEIfC.js";import{c as f,s as p}from"./use-text-edit-D_nFvhaR.js";import{c as m,n as h,s as g,t as _}from"./artboard-canvas-C-Pv53Bu.js";function v(e){let t=m(),n=f({document:e.selection.document,view:t.view,onMove:()=>{},onInsertAt:()=>{},onReposition:()=>{}});return(0,y.jsx)(_,{...e,canvasView:t,nodeDrag:n})}var y,b,x,S,C,w,T,E,D;e((()=>{i(),o(),u(),g(),p(),n(),h(),y=t(),{fn:b}=__STORYBOOK_MODULE_TEST__,x={title:`features/canvas/ArtboardCanvas`,component:v,parameters:{layout:`fullscreen`},decorators:[e=>(0,y.jsx)(`div`,{className:`h-screen bg-gray-100`,children:(0,y.jsx)(e,{})})],args:{tokenSelection:s.create(l,r.none),isFrozen:!1,onSelect:b(),onSelectInRange:b(),onResize:b(),onEditProp:b(),onRepositionArtboard:b()}},S={name:`選択なし`,args:{selection:c()}},C={name:`artboard を選択中`,args:{selection:c([`settings`])}},w={name:`トークンを選択中`,args:{selection:c(),tokenSelection:s.create(l,r.some({kind:`colors`,name:`primary`}))}},T={name:`artboard がない`,args:{selection:a.fromNames(d,[]),tokenSelection:s.create(d,r.none)}},E={name:`ファイルが不正（凍結中）`,args:{selection:c([`home`]),isFrozen:!0}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
