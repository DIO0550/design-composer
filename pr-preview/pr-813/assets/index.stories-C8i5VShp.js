import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-CPpfsGoD.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{n as i,t as a}from"./left-pane-shell-Bg7Fse5V.js";import{n as o,r as s,t as c}from"./design-document-nUsRK2Y5.js";import{n as l,t as u}from"./document-selection-DILK44U_.js";import{n as d,t as f}from"./name-filter-CsfJnjKR.js";import{n as p,t as m}from"./document-tree-CgPpG9LL.js";import{a as h,i as g,n as _,r as v}from"./sample-sidebar-document-j-3wioTj.js";var y,b,x,S,C,w,T,E,D,O,k;e((()=>{i(),o(),l(),d(),g(),_(),t(),p(),y=r(),{fn:b}=__STORYBOOK_MODULE_TEST__,x={title:`features/editor/features/sidebar/DocumentTree`,component:m,parameters:{layout:`padded`},decorators:[e=>(0,y.jsx)(a,{children:(0,y.jsx)(`div`,{className:`p-3`,children:(0,y.jsx)(e,{})})})],args:{onSelect:b(),onReorder:b(),renaming:n.none,filter:n.none,renameActions:h()}},S={name:`選択なし`,args:{selection:v()}},C={name:`別の artboard を選択中`,args:{selection:v(`settings`)}},w={name:`artboard 配下のノードを選択中`,args:{selection:v(`home-title`)}},T={name:`絞り込みで一致した行だけが出ている`,args:{selection:v(),filter:f.create(`title`)}},E=u.fromNames(c.create({tokens:s.Default.tokens,components:s.Default.components,artboards:[{name:`nested`,width:360,height:240,props:{layout:`column`,gap:`md`,paddingRight:`lg`,paddingLeft:`lg`},children:[{name:`header`,type:`Text`,props:{content:`見出し`,typography:`heading`}},{name:`body`,type:`Box`,props:{layout:`column`,gap:`sm`},children:[{name:`body-text`,type:`Text`,props:{content:`本文`}},{name:`body-action`,ref:`primary-button`,overrides:{label:`送信`}}]},{name:`footer`,type:`Text`,props:{content:`脚注`}}]}]}),[]),D={name:`入れ子のノードと並べ替え`,args:{selection:E}},O={name:`行の名前を編集中`,args:{selection:v(`home-title`),renaming:n.some(`home-title`)}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
