import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-C-HBMf2L.js";import{t as i}from"./jsx-runtime-6sF1Ejqi.js";import{n as a,t as o}from"./document-selection-CqPpxX_N.js";import{n as s,t as c}from"./pane-body-CLS2jX36.js";import{n as l,t as u}from"./pane-heading-D5e91x9m.js";import{t as d}from"./shorthand-row-C5zbr4Qq.js";import{n as f,t as p}from"./property-panel-BOx9_-PN.js";function m(e){return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(u,{children:(0,h.jsx)(p.Title,{selection:e.selection})}),(0,h.jsx)(c,{children:(0,h.jsx)(p.Body,{...e})})]})}var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L;e((()=>{s(),l(),t(),a(),f(),h=i(),{expect:g,fn:_,screen:v,userEvent:y}=__STORYBOOK_MODULE_TEST__,b=`very-long-node-name-that-does-not-fit-in-the-heading`,x=r.create({tokens:n.Default.tokens,components:n.Default.components,artboards:[{name:`home`,width:360,height:240,props:{direction:`column`,gap:`md`,paddingTop:`lg`,paddingRight:`lg`,paddingBottom:`lg`,paddingLeft:`lg`,background:`white`},children:[{name:`home-title`,type:`Text`,props:{content:`ホーム`,typography:`heading`}},{name:`home-login`,ref:`primary-button`,overrides:{label:`ログイン`}}]},{name:`overflow`,width:240,height:160,props:{paddingTop:`md`,paddingRight:`md`,paddingBottom:`md`,paddingLeft:`md`,background:`white`},children:[{name:`overflow-wide`,type:`Box`,props:{widthMode:`fixed`,width:480,heightMode:`fixed`,height:320,background:`primary`,radius:`md`},children:[]}]}]}),S=r.create({artboards:[{name:`home`,width:360,height:240,children:[{name:`unset-box`,type:`Box`,props:{background:`missing`}}]}]}),C=r.create({tokens:n.Default.tokens,artboards:[{name:`home`,width:360,height:240,children:[{name:`uniform-padding-box`,type:`Box`,props:{paddingTop:`md`,paddingRight:`md`,paddingBottom:`md`,paddingLeft:`md`}},{name:`mixed-padding-box`,type:`Box`,props:{paddingTop:`sm`,paddingRight:`lg`,paddingBottom:`md`,paddingLeft:`lg`}}]}]}),w=r.create({artboards:[{name:`home`,width:360,height:240,children:[{name:b,type:`Box`}]}]}),T={title:`features/inspector/PropertyPanel`,component:m,parameters:{layout:`padded`},decorators:[e=>(0,h.jsx)(`div`,{className:`flex h-[32rem] w-72 flex-col border border-gray-300 bg-white`,children:(0,h.jsx)(e,{})})],args:{isFrozen:!1,onClearSelection:_(),onEditProp:_(),instance:{goToSource:_(),selectAllInstances:_(),detach:_()}}},E={name:`選択されていない`,args:{selection:o.fromNames(x,[])}},D={name:`artboard を選択中`,args:{selection:o.fromNames(x,[`home`])}},O={name:`Text ノードを選択中`,args:{selection:o.fromNames(x,[`home-title`])}},k={name:`インスタンスを選択中（publicProps から生成）`,args:{selection:o.fromNames(x,[`home-login`])}},A={name:`Box ノードを選択中`,args:{selection:o.fromNames(x,[`overflow-wide`])}},j={name:`未指定の prop だけの Box を選択中`,args:{selection:o.fromNames(S,[`unset-box`])}},M={name:`名前が長いノードを選択中`,args:{selection:o.fromNames(w,[b])}},N={name:`凍結中`,args:{selection:o.fromNames(x,[`home`]),isFrozen:!0}},P={name:`padding が揃っている Box を選択中`,args:{selection:o.fromNames(C,[`uniform-padding-box`])}},F={name:`padding が不揃いな Box を選択中`,args:{selection:o.fromNames(C,[`mixed-padding-box`])}},I={name:`padding を辺ごとに出した Box を選択中`,args:{selection:o.fromNames(C,[`mixed-padding-box`])},play:async()=>{await y.click(v.getByRole(`button`,{name:d.perEdge})),await g(v.getByRole(`combobox`,{name:`Padding Top`})).toBeDefined()}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  name: "選択されていない",
  args: {
