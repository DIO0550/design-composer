import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-CPpfsGoD.js";import{n as r,t as i}from"./snap-guide-overlay-DcLKhO6s.js";import{n as a,t as o}from"./overlay-stage-BZBMyStL.js";var s,c,l,u;e((()=>{t(),a(),r(),s={title:`features/editor/features/canvas/ArtboardCanvas/SnapGuideOverlay`,component:i,parameters:{layout:`fullscreen`,docs:{description:{component:"揃った辺に引くガイド線（映し方は `OverlayStage` の doc を参照）。"}}},decorators:[o]},c={name:`左右の辺が揃った`,args:{guides:{horizontal:n.some({left:159,top:40,width:2,height:140}),vertical:n.none}}},l={name:`縦横の両方で揃った`,args:{guides:{horizontal:n.some({left:159,top:40,width:2,height:140}),vertical:n.some({left:60,top:99,width:240,height:2})}}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  name: "左右の辺が揃った",
  args: {
    guides: {
