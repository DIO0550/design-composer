import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,r,t as i}from"./design-document-YjaXahWS.js";import{d as a}from"./node-resize-Bv0muixD.js";import{a as o,c as s,g as c,h as l,l as u,n as d,o as f,r as p,s as m,t as h}from"./editor-top-bar-BJIuUE7W.js";function g({tone:e,saveState:t,fileErrors:n,elapsed:r}){return(0,_.jsxs)(h,{tone:e,children:[(0,_.jsx)(h.Breadcrumb,{opened:v}),t?(0,_.jsx)(h.SaveBadge,{state:t}):null,n?(0,_.jsx)(h.FileInvalidBadge,{errors:n}):null,(0,_.jsx)(h.Zoom,{view:a.create(),onZoomIn:()=>{},onZoomOut:()=>{},onReset:()=>{}}),r?(0,_.jsx)(h.LastValidRender,{elapsed:r}):null]})}var _,v,y,b,x,S,C,w,T;e((()=>{n(),u(),f(),m(),c(),p(),_=t(),v={path:`/work/settings-ui/app.dcmp`,document:i.createFromTemplate(r.Default)},y={title:`features/editor/EditorTopBar`,component:g,parameters:{layout:`fullscreen`},args:{tone:d.Normal}},b={name:`保存済み`,args:{saveState:s.Saved}},x={name:`保存中`,args:{saveState:s.Saving}},S={name:`保存に失敗`,args:{saveState:s.fromError({kind:`permissionDenied`,message:`/work/settings-ui/app.dcmp: 書き込みが許可されていない`})}},C={name:`最後に正常だった表示を出している状態`,args:{saveState:s.Saved,elapsed:{unit:o.Seconds,count:4}}},w={name:`ファイルが不正`,args:{tone:d.Error,fileErrors:l,elapsed:{unit:o.Seconds,count:4}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: "保存済み",
  args: {
