import{n as e}from"./chunk-BneVvdWh.js";import{A as t,j as n}from"./primitive-schema-_RoYI3sQ.js";import{n as r,r as i,t as a}from"./asset-grab-CeFs77Qm.js";import{t as o}from"./jsx-runtime-4HHWW5MW.js";import{n as s,t as c}from"./token-selection-D0fRPyAg.js";import{n as l,t as u}from"./left-pane-D5w1H42F.js";import{i as d,r as f}from"./left-pane-rail-BfSU-NtY.js";import{i as p,n as m,r as h}from"./sample-sidebar-document-CMEGUBYS.js";var g=e((()=>{i()})),_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{s(),g(),h(),d(),n(),l(),_=o(),{fn:v}=__STORYBOOK_MODULE_TEST__,y={select:v(),reorder:v(),createComponent:v()},b={select:v(),add:v()},x={title:`features/sidebar/LeftPane`,component:u,parameters:{layout:`fullscreen`},args:{onSelectView:v(),selection:p(),tokenSelection:c.create(m,t.none),isFrozen:!1,node:y,token:b,grab:a},decorators:[e=>(0,_.jsx)(`div`,{className:`flex h-[36rem] w-76 border-gray-300 border-r bg-white`,children:(0,_.jsx)(e,{})})]},S={name:`Layers（ツリー）`,args:{view:f.Layers}},C={name:`Assets（部品のパレット）`,args:{view:f.Assets}},w={name:`Tokens（トークン一覧）`,args:{view:f.Tokens}},T={name:`Assets（行を掴んで運んでいる）`,args:{view:f.Assets,grab:r(`primary-button`)}},E={name:`Layers（ノードを選択中）`,args:{view:f.Layers,selection:p(`home-title`)}},D={name:`Layers（凍結中）`,args:{view:f.Layers,isFrozen:!0}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "Layers（ツリー）",
  args: {
