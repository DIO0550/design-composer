...
ペインの枠は #304）。`,displayName:`RightPaneShell`,filePath:`/home/runner/work/design-composer/design-composer/src/components/__stories__/right-pane-shell.tsx`,methods:[],props:{height:{defaultValue:null,declarations:[{fileName:`design-composer/src/components/__stories__/right-pane-shell.tsx`,name:`TypeLiteral`}],description:``,name:`height`,required:!0,tags:{},type:{name:`enum`,raw:`RightPaneShellHeight`,value:[{value:`"content"`},{value:`"pane"`}]}}},tags:{returns:`受け取った中身を、右ペインと同じ幅の枠に入れたもの`}}}catch{}}));export{o as n,r as t};