import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-CTa-i89e.js";import{n as i,t as a}from"./screen-height-shell-DJmJ8YA6.js";import{a as o,s}from"./opened-document-BiPRk7XR.js";import{i as c,n as l,r as u,t as d}from"./document-start-DcgXrlDq.js";var f,p,m,h,g,_,v,y,b,x;e((()=>{i(),s(),c(),n(),l(),f=t(),p={openDocument:()=>{},createDocument:()=>{},openDocumentAt:()=>{}},m=[`/work/settings-ui/app.dcmp`,`/work/shop/app.dcmp`,`/work/design-system/tokens.dcmp`],h={title:`features/documentStart/DocumentStart`,component:d,parameters:{layout:`fullscreen`},args:{session:{kind:`closed`},actions:p,recentPaths:[],commandFailure:r.none,renderErrors:()=>null},decorators:[e=>(0,f.jsx)(a,{children:(0,f.jsx)(e,{})})]},g={name:`開始画面`},_={name:`最近使ったファイルがある`,args:{recentPaths:m}},v={name:`読み込み中`,args:{session:{kind:`opening`}}},y={name:`開けなかった`,args:{session:{kind:`failed`,failure:{kind:`io`,error:o.create(`missing`,`/work/settings-ui/app.dcmp`)}}}},b={name:`メニューを受け取れない`,args:{commandFailure:r.some({source:u.Menu,message:`listen が失敗した`})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: "開始画面"
