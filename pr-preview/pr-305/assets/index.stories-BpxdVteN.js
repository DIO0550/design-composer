import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-ByzVpLNU.js";import{n as i,t as a}from"./node-insert-toolbar-KVXAgM9B.js";var o,s,c,l,u,d;e((()=>{n(),i(),o=t(),s={title:`features/canvas/NodeInsertToolbar`,component:a,parameters:{layout:`fullscreen`},args:{onInsert:()=>{},dragged:r.none},decorators:[e=>(0,o.jsx)(`div`,{className:`relative h-64 w-full bg-gray-100`,children:(0,o.jsx)(`div`,{className:`absolute inset-x-0 bottom-4 flex justify-center`,children:(0,o.jsx)(e,{})})})]},c={name:`挿せる位置がある`,args:{isInsertEnabled:!0}},l={name:`何も選んでいない`,args:{isInsertEnabled:!1}},u={name:`部品を運んでいる`,args:{isInsertEnabled:!0,dragged:r.some({kind:`instance`,componentName:`primary-button`})}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  name: "挿せる位置がある",
  args: {
