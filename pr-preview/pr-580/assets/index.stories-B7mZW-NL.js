import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-CPpfsGoD.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{n as i,t as a}from"./left-pane-shell-Bg7Fse5V.js";import{n as o,r as s,t as c}from"./artboard-list-DDOMXljs.js";import{a as l,i as u,o as d,r as f,t as p}from"./sample-sidebar-document-CdMt_93Y.js";function m(e){return o.full(e.document.artboards)}var h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{i(),l(),f(),t(),s(),h=r(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`features/sidebar/ArtboardList`,component:c,parameters:{layout:`padded`},decorators:[e=>(0,h.jsx)(a,{children:(0,h.jsx)(`div`,{className:`p-3`,children:(0,h.jsx)(e,{})})})],args:{onSelect:g(),artboardActions:{add:g(),reorder:g()},renaming:n.none,renameActions:d()}},v=u(),y={name:`選択なし（先頭が今の 1 枚）`,args:{selection:v,listing:m(v)}},b=u(`settings`),x={name:`別の artboard を選択中`,args:{selection:b,listing:m(b)}},S=u(`settings-card`),C={name:`artboard 配下のノードを選択中`,args:{selection:S,listing:m(S)}},w={name:`artboard がない`,args:{selection:p,listing:m(p)}},T={name:`絞り込みで 1 枚だけ残っている`,args:{selection:v,listing:o.filtered(v.document.artboards.slice(0,1))}},E={name:`一致するものがない`,args:{selection:v,listing:o.filtered([])}},D={name:`行の名前を編集中`,args:{selection:v,listing:m(v),renaming:n.some(`home`)}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  name: "選択なし（先頭が今の 1 枚）",
  args: {
