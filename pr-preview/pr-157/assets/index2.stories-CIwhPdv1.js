import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./design-document-CuauvRgR.js";import{a as r,i,n as a,r as o}from"./sample-editor-state-lg2VE7Yc.js";import{t as s}from"./jsx-runtime-6sF1Ejqi.js";import{n as c,t as l}from"./property-panel-Ch3q0o5A.js";var u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{t(),o(),r(),c(),u=s(),{fn:d}=__STORYBOOK_MODULE_TEST__,f=`very-long-node-name-that-does-not-fit-in-the-heading`,p=i.create(n.create({artboards:[{name:`home`,width:360,height:240,children:[{name:f,type:`Box`}]}]})),m={title:`features/editor/PropertyPanel`,component:l,parameters:{layout:`padded`},decorators:[e=>(0,u.jsx)(`div`,{className:`flex h-[32rem] w-72 flex-col border border-gray-300 bg-white`,children:(0,u.jsx)(e,{})})],args:{onClearSelection:d(),onEditProp:d()}},h={name:`選択されていない`,args:{state:a}},g={name:`artboard を選択中`,args:{state:i.select(a,`home`)}},_={name:`Text ノードを選択中`,args:{state:i.select(a,`home-title`)}},v={name:`インスタンスを選択中（publicProps から生成）`,args:{state:i.select(a,`home-login`)}},y={name:`Box ノードを選択中`,args:{state:i.select(a,`overflow-wide`)}},b={name:`名前が長いノードを選択中`,args:{state:i.select(p,f)}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: "選択されていない",
  args: {
