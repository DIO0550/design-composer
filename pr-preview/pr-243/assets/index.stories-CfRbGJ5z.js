import{n as e}from"./chunk-BneVvdWh.js";import{a as t,t as n}from"./compiled-element-Dm9DmER7.js";import{n as r,t as i}from"./artboard-label-DPkfij_3.js";var a,o,s,c;e((()=>{t(),r(),a={title:`features/editor/ArtboardCanvas/ArtboardLabel`,component:i,parameters:{layout:`centered`,docs:{description:{component:`artboard の見出し（UI 案 docs/Design Composer.html。名前の右に大きさが並ぶ）。
...
縮んだ artboard の上に小さく載るので色の差を読み取りにくい。`}}},args:{artboard:{element:n.create(`login`,[],[]),width:720,height:900}}},o={name:`今見ている 1 枚`,args:{isCurrent:!0}},s={name:`他の artboard`,args:{isCurrent:!1}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: "今見ている 1 枚",
  args: {
    isCurrent: true
  }
