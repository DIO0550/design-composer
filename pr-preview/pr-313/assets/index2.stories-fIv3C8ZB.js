import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./Option-CEQn841D.js";import{n as i,t as a}from"./token-selection-DImtwwwE.js";import{i as o,r as s}from"./sample-canvas-document-D9UJJNBV.js";import{g as c,h as l}from"./artboard-frame-aBWEePE4.js";import{n as u,t as d}from"./canvas-controls-CeXxOvHj.js";import{n as f,t as p}from"./artboard-frame-list-GHHha3Fs.js";function m({selection:e}){let t=l.compile(e.document);return t.ok?(0,h.jsx)(d,{selection:e,children:n=>(0,h.jsx)(p,{compiled:t.value,selection:e,tokenSelection:a.create(e.document,r.none),onSelect:()=>{},...n})}):(0,h.jsxs)(`p`,{children:[`コンパイルに失敗しました: `,t.error.message]})}var h,g,_,v,y,b;e((()=>{i(),s(),c(),n(),u(),f(),h=t(),g={title:`features/canvas/ArtboardCanvas/ArtboardFrameList`,component:m,parameters:{layout:`fullscreen`},decorators:[e=>(0,h.jsx)(`div`,{className:`h-[32rem] w-full overflow-auto bg-gray-100`,children:(0,h.jsx)(e,{})})]},_={name:`選択なし`,args:{selection:o()}},v={name:`artboard を選択中`,args:{selection:o([`settings`])}},y={name:`配下のノードを選択中`,args:{selection:o([`overflow-wide`])}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
