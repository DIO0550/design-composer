import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./design-document-B-4r0qA3.js";import{a as r,i,n as a,r as o}from"./sample-editor-state-Bq3EDzMt.js";import{i as s,n as c,r as l,t as u}from"./opened-document-editor-BSdY_Ns4.js";import{l as d,u as f}from"./document-save-state-C2EtDZ5m.js";var p,m,h,g,_,v,y,b;e((()=>{t(),o(),r(),s(),f(),c(),p=`/work/sample.dcmp`,m={title:`features/editor/OpenedDocumentEditor`,component:u,parameters:{layout:`fullscreen`},args:{ipc:l.create({[p]:d.serialize(i.document(a))}).ipc,opened:{path:p,document:i.document(a)}}},h={name:`編集画面`},g={name:`同期に失敗した編集画面`,args:{ipc:l.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:i.document(a)}}},_=i.document(a),v=n.create({components:_.components,artboards:_.artboards,tokens:{..._.tokens,typography:Object.fromEntries(Object.entries(_.tokens.typography).filter(([e])=>e!==`heading`))}}),y={name:`編集で作った不正がある編集画面`,args:{ipc:l.create({[p]:d.serialize(v)}).ipc,opened:{path:p,document:v}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
