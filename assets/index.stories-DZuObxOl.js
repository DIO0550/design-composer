import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-Bq002N32.js";import{t as r}from"./jsx-runtime-4HHWW5MW.js";import{n as i,t as a}from"./left-pane-shell-DP5S5Z1P.js";import{n as o,r as s,t as c}from"./design-document-nXkCQk4W.js";import{n as l,t as u}from"./create-component-VvzLt-xE.js";var d,f=e((()=>{o(),d=c.create({tokens:s.Default.tokens,components:s.Default.components,artboards:[{name:`home`,width:360,height:240,children:[{name:`home-panel`,type:`Box`,children:[{name:`home-title`,type:`Text`}]},{name:`home-login`,ref:`primary-button`}]}]})}));async function p(){await y.click(v.getByRole(`button`,{name:/Create component/})),await y.type(v.getByRole(`textbox`,{name:`部品名`}),b)}function m(){return v.getByRole(`button`,{name:/Create component/}).hasAttribute(`disabled`)}var h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{i(),f(),t(),l(),h=r(),{expect:g,fn:_,screen:v,userEvent:y}=__STORYBOOK_MODULE_TEST__,b=`info-panel`,x={title:`features/assets/CreateComponent`,component:u,parameters:{layout:`padded`},args:{document:d,singleName:n.some(`home-title`),isFrozen:!1,onCreate:_()},decorators:[e=>(0,h.jsx)(a,{children:(0,h.jsx)(e,{})})]},S={name:`ノードを選んでいる`},C={name:`インスタンスを選んでいる`,args:{singleName:n.some(`home-login`)}},w={name:`artboard を選んでいる`,args:{singleName:n.some(`home`)}},T={name:`何も選んでいない`,args:{singleName:n.none}},E={name:`部品名を打っている`,play:async()=>{await p(),await g(m()).toBe(!1)}},D={name:`ファイルが不正な間に部品名を打っている`,args:{isFrozen:!0},play:async()=>{await p(),await g(m()).toBe(!0)}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: "ノードを選んでいる"
