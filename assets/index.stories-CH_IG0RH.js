import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./Option-CPpfsGoD.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{r as i,t as a}from"./document-access-failure-BcxtFGzp.js";import{n as o,t as s}from"./screen-height-shell-DUxeWi4g.js";import{i as c,l,n as u,r as d,t as f,u as p}from"./document-start-O3685tfA.js";var m,h,g,_,v,y,b,x,S,C,w;e((()=>{o(),i(),p(),c(),t(),u(),m=r(),h={openDocument:()=>{},createDocument:()=>{},openDocumentsAt:()=>{}},g=[`/work/settings-ui/app.dcmp`,`/work/shop/app.dcmp`,`/work/design-system/tokens.dcmp`],_={title:`features/documentStart/DocumentStart`,component:f,parameters:{layout:`fullscreen`},args:{attempt:l.Idle,actions:h,recentPaths:[],recentFilesFailure:n.none,commandFailure:n.none,renderErrors:()=>null},decorators:[e=>(0,m.jsx)(s,{children:(0,m.jsx)(e,{})})]},v={name:`開始画面`},y={name:`最近使ったファイルがある`,args:{recentPaths:g}},b={name:`読み込み中`,args:{attempt:l.Opening}},x={name:`開けなかった`,args:{attempt:l.failed({kind:`io`,error:a.create(`missing`,`/work/settings-ui/app.dcmp`)})}},S={name:`最近使ったファイルを読み込めない`,args:{recentFilesFailure:n.some(`app-state.json: 読み込みが拒まれた`)}},C={name:`メニューを受け取れない`,args:{commandFailure:n.some({source:d.Menu,message:`listen が失敗した`})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  name: "開始画面"
