import{n as e}from"./chunk-BneVvdWh.js";import{n as t,r as n,t as r}from"./design-document-C-HBMf2L.js";import{t as i}from"./jsx-runtime-6sF1Ejqi.js";import{d as a}from"./node-resize-CGayHigU.js";import{_ as o,a as s,c,l,n as u,o as d,r as f,s as p,t as m,v as h}from"./editor-top-bar-_xUlvAXX.js";function g({tone:e,saveState:t,fileErrors:n,elapsed:r}){return(0,_.jsxs)(m,{tone:e,children:[(0,_.jsx)(m.Breadcrumb,{opened:v}),t?(0,_.jsx)(m.SaveBadge,{state:t}):null,n?(0,_.jsx)(m.FileInvalidBadge,{errors:n}):null,(0,_.jsx)(m.Zoom,{view:a.create(),onZoomIn:()=>{},onZoomOut:()=>{},onReset:()=>{}}),r?(0,_.jsx)(m.LastValidRender,{elapsed:r}):null]})}var _,v,y,b,x,S,C,w,T;e((()=>{t(),l(),d(),p(),h(),f(),_=i(),v={path:`/work/settings-ui/app.dcmp`,document:r.createFromTemplate(n.Default)},y={title:`features/editor/EditorTopBar`,component:g,parameters:{layout:`fullscreen`},args:{tone:u.Normal}},b={name:`保存済み`,args:{saveState:c.Saved}},x={name:`保存中`,args:{saveState:c.Saving}},S={name:`保存に失敗`,args:{saveState:c.fromError({kind:`permissionDenied`,message:`/work/settings-ui/app.dcmp: 書き込みが許可されていない`})}},C={name:`最後に正常だった表示を出している状態`,args:{saveState:c.Saved,elapsed:{unit:s.Seconds,count:4}}},w={name:`ファイルが不正`,args:{tone:u.Error,fileErrors:o,elapsed:{unit:s.Seconds,count:4}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: "保存済み",
  args: {
