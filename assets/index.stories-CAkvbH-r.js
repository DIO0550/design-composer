import{n as e}from"./chunk-BneVvdWh.js";import{M as t,j as n}from"./primitive-schema-Ke4zSQuu.js";import{t as r}from"./jsx-runtime-4HHWW5MW.js";import{n as i,t as a}from"./token-selection-Bwkb2tHj.js";import{i as o,r as s}from"./sample-canvas-document-BMfWHKF5.js";import{g as c,h as l}from"./artboard-frame-CHdZHmO3.js";import{n as u,t as d}from"./canvas-controls-DDl-BMYX.js";import{n as f,t as p}from"./artboard-frame-list-BnfIS3er.js";function m({selection:e}){let t=l.compile(e.document);return t.ok?(0,h.jsx)(d,{selection:e,children:r=>(0,h.jsx)(p,{compiled:t.value,selection:e,tokenSelection:a.create(e.document,n.none),onSelect:()=>{},...r})}):(0,h.jsxs)(`p`,{children:[`コンパイルに失敗しました: `,t.error.message]})}var h,g,_,v,y,b;e((()=>{i(),s(),c(),t(),u(),f(),h=r(),g={title:`features/canvas/ArtboardCanvas/ArtboardFrameList`,component:m,parameters:{layout:`fullscreen`},decorators:[e=>(0,h.jsx)(`div`,{className:`h-[32rem] w-full overflow-auto bg-gray-100`,children:(0,h.jsx)(e,{})})]},_={name:`選択なし`,args:{selection:o()}},v={name:`artboard を選択中`,args:{selection:o([`settings`])}},y={name:`配下のノードを選択中`,args:{selection:o([`overflow-wide`])}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
