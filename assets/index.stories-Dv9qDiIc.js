import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-D16BNjX-.js";import{n,r,t as i}from"./shorthand-row-1VjOv7Dw.js";import{f as a,h as o,l as s,p as c,u as l}from"./panel-controls-DW8bkQ85.js";import{n as u,t as d}from"./panel-frame-BBIlUOs8.js";var f,p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{o(),u(),r(),f=t(),{expect:p,fn:m,screen:h,userEvent:g}=__STORYBOOK_MODULE_TEST__,_={title:`features/inspector/PropertyPanel/ShorthandRow`,component:n,parameters:{layout:`padded`,docs:{description:{component:`4 つの longhand を 1 行にまとめた行。
...
}`,...b.parameters?.docs?.source},description:{story:"切り替えは `useState` なので、押した後の 2×2 は `play` を通さないと視覚差分に載らない。",...b.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  name: "4 隅が揃っている",
  args: {
...
}`,...C.parameters?.docs?.source},description:{story:"切り替えは `useState` なので、押した後の 2×2 は `play` を通さないと視覚差分に載らない。",...C.parameters?.docs?.description}}},w=[`Uniform`,`Mixed`,`PerEdge`,`UniformCorners`,`MixedCorners`,`PerCorner`]}))();export{y as Mixed,S as MixedCorners,C as PerCorner,b as PerEdge,v as Uniform,x as UniformCorners,w as __namedExportsOrder,_ as default};