...
なるためで、引いている間は土台が捕捉していて**外してもテストも絵も変わらない**。`,displayName:`RangeSelectOverlay`,filePath:`/home/runner/work/design-composer/design-composer/src/features/editor/features/canvas/components/artboard-canvas/range-select-overlay/index.tsx`,methods:[],props:{bounds:{defaultValue:null,declarations:[{fileName:`design-composer/src/features/editor/features/canvas/components/artboard-canvas/range-select-overlay/index.tsx`,name:`TypeLiteral`}],description:``,name:`bounds`,required:!0,tags:{},type:{name:`Readonly<{ left: number; top: number; width: number; height: number; }>`}}},tags:{returns:`引いている範囲を示す矩形`}}}catch{}}));export{o as n,i as t};