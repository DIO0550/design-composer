import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-4HHWW5MW.js";import{a as n,r}from"./sample-editor-state-BfgnA-CH.js";import{n as i,t as a}from"./editor-state-BjpDeIft.js";import{g as o,h as s}from"./artboard-frame-CS-sO6C3.js";import{n as c,t as l}from"./canvas-controls-DOwyKN0f.js";import{n as u,t as d}from"./artboard-frame-list-B2Yrmc2K.js";function f({state:e}){let t=s.compile(a.document(e));return t.ok?(0,p.jsx)(l,{state:e,children:n=>(0,p.jsx)(d,{compiled:t.value,state:e,onSelect:()=>{},...n})}):(0,p.jsxs)(`p`,{children:[`コンパイルに失敗しました: `,t.error.message]})}var p,m,h,g,_,v;e((()=>{n(),i(),o(),c(),u(),p=t(),m={title:`features/editor/ArtboardCanvas/ArtboardFrameList`,component:f,parameters:{layout:`fullscreen`},decorators:[e=>(0,p.jsx)(`div`,{className:`h-[32rem] w-full overflow-auto bg-gray-100`,children:(0,p.jsx)(e,{})})]},h={name:`選択なし`,args:{state:r}},g={name:`artboard を選択中`,args:{state:a.select(r,`settings`)}},_={name:`配下のノードを選択中`,args:{state:a.select(r,`overflow-wide`)}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: "選択なし",
  args: {
