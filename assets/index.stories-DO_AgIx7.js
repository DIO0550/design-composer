import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./design-document-B-7AsI0c.js";import{a as r,r as i}from"./sample-editor-state-DuIDV25x.js";import{n as a,t as o}from"./editor-state-3cICpLSW.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./opened-document-editor-CL7Ly4Yi.js";import{m as p,p as m}from"./elapsed-CAE19cGd.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{t(),r(),a(),u(),c(),p(),l(),{expect:h,screen:g,waitFor:_}=__STORYBOOK_MODULE_TEST__,v=`/work/sample.dcmp`,y=d.create({[v]:m.serialize(o.document(i))}),b={title:`features/editor/OpenedDocumentEditor`,component:f,parameters:{layout:`fullscreen`},args:{clock:s.create().clock,ipc:y.ipc,opened:{path:v,document:o.document(i)}}},x={name:`編集画面`},S={name:`同期に失敗した編集画面`,args:{ipc:d.create({}).ipc,opened:{path:`/work/missing.dcmp`,document:o.document(i)}}},C=o.document(i),w=n.create({components:C.components,artboards:C.artboards,tokens:{...C.tokens,typography:Object.fromEntries(Object.entries(C.tokens.typography).filter(([e])=>e!==`heading`))}}),T={name:`編集で作った不正がある編集画面`,args:{ipc:d.create({[v]:m.serialize(w)}).ipc,opened:{path:v,document:w}}},E=d.create({[v]:m.serialize(o.document(i))}),D={name:`ファイルが不正になった編集画面`,args:{ipc:E.ipc,opened:{path:v,document:o.document(i)}},play:async()=>{await _(()=>{h(E.isWatching(v)).toBe(!0)}),E.changeExternally(v,`{ 壊れた`),await _(()=>{h(g.getByText(`最後に正常だった表示`)).toBeDefined()})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  name: "編集画面"
