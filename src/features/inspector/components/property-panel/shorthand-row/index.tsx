...
/**
 * 4 辺を 1 行にまとめた行（UI 案 docs/Design Composer.html の `padding`）。半幅セルを 2
 * 列のグリッドに詰めるところまで UI 案と同じ。
 *
 * 既定を畳んだ 2 欄にするのは Figma と同じ形にするため（#230）。UI 案は 4 辺の状態しか
 * 描いていないので、切り替えボタンの見た目はここで決めている。
 *
