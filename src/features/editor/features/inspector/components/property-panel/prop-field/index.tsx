...
/**
 * 未指定のときに何が効くかを出す（デフォルト値をプレースホルダとして見せ、明示設定と
 * 区別する）。
 *
...
function LiteralInput({
   ...
   *
   * 同じ形の ref が `features/editor/features/canvas` の `use-node-resize` にもある。畳む先が
 ...
 *
 * 値と編集の作り方を `FieldBinding` で受けるので、1 prop の行と畳んだ欄のどちらからも同じ
 * ものを描ける（欄の見た目を 2 通りに割らない）。
 *
