...
import { CommandSources } from "@/features/editor/features/document-start/hooks/use-document-session";
...
const meta = {
  title: "features/editor/features/document-start/DocumentStart",
