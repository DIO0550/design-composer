...
import {
  ...
  DocumentSession,
  type OpenOutcome,
} from "@/features/editor/features/document-start/domains/document-session";
import { RecentFiles } from "@/features/editor/features/document-start/domains/recent-files";
