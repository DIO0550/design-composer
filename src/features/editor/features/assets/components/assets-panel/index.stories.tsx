...
const meta = {
  title: "features/editor/features/assets/AssetsPanel",
  ...
  // 左ペインの見出し帯（`LeftPanePanel`）は付けない。features/editor/features/sidebar
  // 側の器を deep import せずに済ませるため
  // （rules/architecture.md「モジュールの公開API」）。
  decorators: [
    (Story) => (
      <LeftPaneShell>
        <div className="p-3">
