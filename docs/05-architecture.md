...
- ここで規定しているのは**ドキュメント本体**の永続化だけ。アプリ自身の状態（最後に開いたパス・最近使ったファイル等）の置き場は未規定（[#376](https://github.com/DIO0550/design-composer/issues/376)）。同時に開けるドキュメントの数も規定していない（実装は 1 つ / [#375](https://github.com/DIO0550/design-composer/issues/375)）
